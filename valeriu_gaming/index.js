...
module.exports = {
	...
	randomCase: function(string) {
		let result = '';
		if (!string) throw new TypeError('A string was not specified.');
		if (typeof string !== 'string') {
			throw new TypeError('Provided string is Invalid.');
		}
	...
	randomizeNumber: function(start, end) {
		if (!start) throw new TypeError('A number was not specified.');
		if (!end) throw new TypeError('A number was not specified.');
		if (typeof start !== 'number' && typeof end !== 'number') {
			throw new TypeError('Provided number data is Invalid');
		}
...
module.exports.Logo = require('./src/guessTheLogo-game')
module.exports.Flag = require('./src/guessTheFlag-game')
module.exports.Leaderboard = require('./src/fight-leaderboard')
module.exports.News = require('./src/news')